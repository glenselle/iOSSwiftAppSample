...
class KeychainWrapper {
    ...
    */
    ...
    class func dataForKey(keyName: String) -> NSData? {
        ...
        let SecMatchLimit: String! = kSecMatchLimit as NSString as String
        keychainQueryDictionary[SecMatchLimit] = kSecMatchLimitOne
        
        // Specify we want NSData/CFData returned
        let SecReturnData: String! = kSecReturnData as NSString as String
    ...
    class func setData(value: NSData, forKey keyName: String) -> Bool {
        ...
        let SecValueData: String! = kSecValueData as NSString as String
        keychainQueryDictionary[SecValueData] = value
        
        // Protect the keychain entry so it's only valid when the device is unlocked
        let SecAttrAccessible: String! = kSecAttrAccessible as NSString as String
    ...
    private class func updateData(value: NSData, forKey keyName: String) -> Bool {
        ...
        // Update
        let status: OSStatus = SecItemUpdate(keychainQueryDictionary, updateDictionary as NSDictionary)
    ...
    private class func setupKeychainQueryDictionaryForKey(keyName: String) -> NSMutableDictionary {
        ...
        let SecClass: String! = kSecClass as NSString as String
        var keychainQueryDictionary: NSMutableDictionary = [SecClass:kSecClassGenericPassword]
        
        // Uniquely identify this keychain accessor
        let SecAttrService: String! = kSecAttrService as NSString as String
        ...
        let SecAttrGeneric: String! = kSecAttrGeneric as NSString as String
        keychainQueryDictionary[SecAttrGeneric] = encodedIdentifier
        
        let SecAttrAccount: String! = kSecAttrAccount as NSString as String
